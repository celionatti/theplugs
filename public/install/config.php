...
return [
    ...
    'files' => [
        ...
        // 'resources/views/pagination/tailwind.plug.php' => 'views/pagination/tailwind.plug.php.template',
        // 'resources/views/pagination/bootstrap.plug.php' => 'views/pagination/bootstrap.plug.php.template',
        // 'resources/views/pagination/simple.plug.php' => 'views/pagination/simple.plug.php.template',
        // 'resources/views/pdf/invoice.plug.php' => 'views/pdf/invoice.plug.php.template',
        // 'resources/views/pdf/receipt.plug.php' => 'views/pdf/receipt.plug.php.template',
        // 'resources/views/pdf/ticket.plug.php' => 'views/pdf/ticket.plug.php.template',
        '.env' => 'env.template',
